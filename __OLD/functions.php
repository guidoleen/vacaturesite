...
function guidoleen_setup() {
	...
	add_editor_style( array( 'css/editor-style.css', guidoleen_fonts_url() ) );
 ...
 * @since Twenty Sixteen 1.0
 */
function guidoleen_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'guidoleen_content_width', 840 );
}
add_action( 'after_setup_theme', 'guidoleen_content_width', 0 );
...
if ( ! function_exists( 'guidoleen_fonts_url' ) ) :
/**
 * Register Google fonts for Twenty Sixteen.
 *
 * Create your own guidoleen_fonts_url() function to override in a child theme.
 *
 * @since Twenty Sixteen 1.0
 *
...
function guidoleen_fonts_url() {
	...
	if ( 'off' !== _x( 'on', 'Merriweather font: on or off', 'guidoleen' ) ) {
		$fonts[] = 'Merriweather:400,700,900,400italic,700italic,900italic';
	}

	/* translators: If there are characters in your language that are not supported by Montserrat, translate this to 'off'. Do not translate into your own language. */
	if ( 'off' !== _x( 'on', 'Montserrat font: on or off', 'guidoleen' ) ) {
		$fonts[] = 'Montserrat:400,700';
	}

	/* translators: If there are characters in your language that are not supported by Inconsolata, translate this to 'off'. Do not translate into your own language. */
	if ( 'off' !== _x( 'on', 'Inconsolata font: on or off', 'guidoleen' ) ) {
 ...
 * @since Twenty Sixteen 1.0
 */
function guidoleen_javascript_detection() {
	echo "<script>(function(html){html.className = html.className.replace(/\bno-js\b/,'js')})(document.documentElement);</script>\n";
}
add_action( 'wp_head', 'guidoleen_javascript_detection', 0 );
...
function guidoleen_scripts() {
	// Theme stylesheet.
	wp_enqueue_style( 'guidoleen-style', get_stylesheet_uri() );

	// Load the html5 shiv.
	wp_enqueue_script( 'guidoleen-html5', get_template_directory_uri() . '/js/html5.js', array(), '3.7.3' );
	wp_script_add_data( 'guidoleen-html5', 'conditional', 'lt IE 9' );

	wp_enqueue_script( 'guidoleen-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20160412', true );
	...
	wp_localize_script( 'guidoleen-script', 'screenReaderText', array(
		'expand'   => __( 'expand child menu', 'guidoleen' ),
		'collapse' => __( 'collapse child menu', 'guidoleen' ),
	) );
}
 ...
 */
function guidoleen_body_classes( $classes ) {
...
add_filter( 'body_class', 'guidoleen_body_classes' );
 ...
 */
function guidoleen_hex2rgb( $color ) {
	$color = trim( $color, '#' );
